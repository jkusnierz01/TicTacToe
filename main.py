...
#         if player == 'x' and node1.gameboard[row][col] == 0:
#             node1.gameboard[row][col] = CROSS
#         elif player == 'o' and node1.gameboard[row][col] == 0:
    ...
    while not ai_node.Terminal() and not node1.Terminal() and gameover is False:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if player == PLAYER_CROSS and node1.gameboard[tab_tuple[0]][tab_tuple[1]] == 0:
                    node1.gameboard[tab_tuple[0]][tab_tuple[1]] = CROSS
                elif player == PLAYER_DOT and node1.gameboard[tab_tuple[0]][tab_tuple[1]] == 0:
